  ...
  return (
    <div className="naksha-map">
      ...
      <style>{`
        ...
        .leaflet-control-zoom{border:2px solid #000!important;box-shadow:2px 2px 0 rgba(0,0,0,.5)!important;border-radius:3px!important;overflow:hidden}.leaflet-control-zoom a{background:#0b0d1f!important;color:#fff!important;border-color:rgba(255,255,255,.1)!important}.leaflet-control-zoom a:hover{background:#232842!important;color:#a78bfa!important}.leaflet-control-scale-line{background:rgba(20,24,42,.9)!important;color:#fff!important;border-color:#fff!important}
